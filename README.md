...
v0.3.1 已加入蜡笔小新、风间彻、正南、阿呆、妮妮五名角色的学习贴纸，删除耳机小恐龙，并把桌面图标换成可爱小书；升序和降序现在保持相同表格布局。PDF 提取、声音语速、部分/全部 Anki 导出和 v0.2 数据继续保留。
...
- [[单词文档配音项目交接文档-2026-07-18]]：v0.3.1 基线、运行路径、验证结果和接手顺序。
...
v0.3.1 构建结果位于 `dist\WordPdfVoice-v0.3.1\WordPdfVoice-v0.3.1.exe`。整个版本文件夹需要一起保留。
