...
v0.3.0 已更新为原创动漫治愈风界面，增加随机贴纸、非连续重复的温暖短句和高 DPI 小屏适配。PDF 提取、声音语速、序号排序、部分/全部 Anki 导出保持不变，现有 v0.2 数据和 1104 条音频直接保留。
...
- [[单词文档配音项目交接文档-2026-07-18]]：v0.3.0 基线、运行路径、验证结果和接手顺序。
...
v0.3.0 构建结果位于 `dist\WordPdfVoice-v0.3.0\WordPdfVoice-v0.3.0.exe`。整个版本文件夹需要一起保留。
