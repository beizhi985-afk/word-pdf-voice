...
v0.2.1 已修复声音和语速被旧缓存遮蔽的问题，并增加序号升序、降序。完整配音尚未结束时，仍可试听已完成词条并导出部分 Anki 卡组；现有 v0.2 数据和 1104 条音频直接保留。
...
- [[单词文档配音项目交接文档-2026-07-18]]：v0.2.1 基线、运行路径、验证结果和接手顺序。
...
v0.2.1 构建结果位于 `dist\WordPdfVoice-v0.2.1\WordPdfVoice-v0.2.1.exe`。整个版本文件夹需要一起保留。
